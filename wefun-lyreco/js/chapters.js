...
var CHAPTERS = {
  shared: [
    {
      num: 1, slug: '1-bookshop', audience: 'shared', track: 'lyreco', displayOrder: 1,
    ...
    {
      num: 2, slug: '2-dynasty', audience: 'shared', track: 'lyreco', displayOrder: 2,
    ...
    {
      num: 3, slug: '3-bigeard', audience: 'shared', track: 'lyreco', displayOrder: 3,
    ...
    {
      num: 4, slug: '4-goes-east', audience: 'shared', track: 'lyreco', displayOrder: 4,
    ...
    {
      num: 5, slug: '5-christmas-eve', audience: 'shared', track: 'wefun', displayOrder: 5,
    ...
    {
      num: 7, slug: '7-convergence', audience: 'shared', track: 'convergence', displayOrder: 7,
      title: 'Convergence',
  ...
  wefun: [
    {
      num: 6, slug: '6-people', audience: 'wefun', track: 'convergence', displayOrder: 6,
    ...
    {
      num: 8, slug: '8-february-26', audience: 'wefun', track: 'convergence', displayOrder: 8,
      title: 'February 26',
    ...
    {
      num: 9, slug: 'w1-strategy-notes', audience: 'wefun', track: 'wefun', displayOrder: 9,
  ...
  lyreco: [
    {
      num: 6, slug: 'l1-wefun-profile', audience: 'lyreco', track: 'wefun', displayOrder: 6,
      title: 'Inside WeFun',
    ...
    {
      num: 8, slug: 'l3-lyreco-convergence', audience: 'lyreco', track: 'convergence', displayOrder: 8,
    ...
    {
      num: 9, slug: 'l2-deal-tracker', audience: 'lyreco', track: 'convergence', displayOrder: 9,
